...
<head>
   ...
   <script src="https://oss.maxcdn.com/respond/1.4.2/respond.min.js"></script><![endif]n -->
</head>
   ...
   <div id="main_slider" class="carousel slide banner-main" data-ride="carousel">
      <div class="carousel-inner">
         <div class="carousel-item active">
            <img class="first-slide" src="images/banner2.jpg" alt="First slide" width="100%">
            <div class="container">
               <div class="carousel-caption relative">
                  <h1>Consulta<br> <strong class="black_bold">de </strong><br>
                     <strong class="yellow_bold">Padrón </strong></h1>
                     <a  href="http://catarto.com.ar/rto/">Hacé click acá</a>
                  </div>
               </div>
            </div>
         </div>
